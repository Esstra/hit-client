...
namespace Esstra.Hit.Client.Entities
{
    ...
    /// <summary>
    /// Anschrift zum Halter und Antragsteller in Milchreduktionsprämie
    /// </summary>
    [Entity("FUNC_ADDRMRED")]
    public class FUNC_ADDRMRED
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the value of "Halter oder Antragsteller".
        /// </summary>
        [Column("BNR15_HAS")]
        public decimal? BNR15_HAS { get; set; }

        /// <summary>
        /// Gets or sets the value of "Halter oder Antragsteller (aufbereitet)".
        /// </summary>
        [Column("BNR15_HASX")]
        public string? BNR15_HASX { get; set; }
        ...
        /// <summary>
        /// Gets or sets the value of "Antragsteller oder Halter eindeutig".
        /// </summary>
        [Column("MRED_AHOK")]
        public bool? MRED_AHOK { get; set; }

        /// <summary>
        /// Gets or sets the value of "Kennzeichen ob Antragsteller oder Halter (spez. Milchreduktionsverfahren)".
        /// </summary>
        [Column("MRED_AORH")]
        public int? MRED_AORH { get; set; }

        /// <summary>
        /// Gets or sets the value of "Timestamp fachlicher Stand".
        /// </summary>
        [Column("MRED_TS")]
        public DateTime? MRED_TS { get; set; }
