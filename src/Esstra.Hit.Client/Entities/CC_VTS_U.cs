...
namespace Esstra.Hit.Client.Entities
{
    ...
    /// <summary>
    /// CC-Kontrolle Bereich 2 Gesundheit - Tierseuchen (Sicht für UN)
    /// </summary>
    [Entity("CC_VTS_U")]
    public class CC_VTS_U
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the value of "Prüfer-Bewertung bei Verstoß gegen 1.systemat. Kriterium im Bereich 2 Gesundheit - Tierseuchen".
        /// </summary>
        /// <remarks>
        /// Seuchenverdacht unverzüglich der zuständigen Behörde angezeigt
        /// </remarks>
        [Column("VTS_S1_PR")]
        public int? VTS_S1_PR { get; set; }
        ...
        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Blauzungenkrankheit".
        /// </summary>
        [Column("MELD_BLAU")]
        public bool? MELD_BLAU { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Rifttalfieber".
        /// </summary>
        [Column("MELD_RIF")]
        public bool? MELD_RIF { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Dermatitis nodularis".
        /// </summary>
        [Column("MELD_DERM")]
        public bool? MELD_DERM { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Afrikanische Schweinepest".
        /// </summary>
        [Column("MELD_ASPE")]
        public bool? MELD_ASPE { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Vesikuläre Stomatitis".
        /// </summary>
        [Column("MELD_VESST")]
        public bool? MELD_VESST { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Schaf- und Ziegenpocken (Capripox)".
        /// </summary>
        [Column("MELD_POCK")]
        public bool? MELD_POCK { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Epizootische Hämorrhagie der Hirsche".
        /// </summary>
        [Column("MELD_EHH")]
        public bool? MELD_EHH { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Vesikuläre Schweinekrankheit".
        /// </summary>
        [Column("MELD_VESSW")]
        public bool? MELD_VESSW { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Pest der kleinen Wiederkäuer".
        /// </summary>
        [Column("MELD_KWPE")]
        public bool? MELD_KWPE { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche Rinderpest".
        /// </summary>
        [Column("MELD_RPE")]
        public bool? MELD_RPE { get; set; }

        /// <summary>
        /// Gets or sets the value of "Meldetatbestand Tierseuche MKS".
        /// </summary>
        [Column("MELD_MKS")]
        public bool? MELD_MKS { get; set; }

        /// <summary>
        /// Gets or sets the value of "Wenn ja, wurde der Seuchenverdacht unverzüglich der zuständigen Behörde angezeigt".
        /// </summary>
        /// <remarks>
        /// Prüftbericht Tierseuchen: Systematische Kontrolle, ob Seuchenverdacht angezeigt
        /// </remarks>
        [Column("VS_SEU_ANZ")]
        public bool? VS_SEU_ANZ { get; set; }

        /// <summary>
        /// Gets or sets the value of "Hätte der Betriebsinhaber/Landwirt (bzw. sein Personal) den Seuchenverdacht erkennen müssen".
        /// </summary>
        /// <remarks>
        /// Prüftbericht Tierseuchen Systematische Kontrolle, ob Seuchenverdacht erkannt
        /// </remarks>
        [Column("VS_SEU_ERK")]
        public bool? VS_SEU_ERK { get; set; }
        ...
        /// <summary>
        /// Gets or sets the value of "Vorsatz beim Verstoß gegen 1.systemat. Kriterium im Bereich 2 Gesundheit - Tierseuchen".
        /// </summary>
        /// <remarks>
        /// Seuchenverdacht unverzüglich der zuständigen Behörde angezeigt
        /// </remarks>
        [Column("VTS_S1_VO")]
        public bool? VTS_S1_VO { get; set; }

        /// <summary>
        /// Gets or sets the value of "Regelverstoß gegen 1.systemat. Kriterium im Bereich 2 Gesundheit - Tierseuchen".
        /// </summary>
        /// <remarks>
        /// Seuchenverdacht unverzüglich der zuständigen Behörde angezeigt
        /// </remarks>
        [Column("VTS_S1_RE")]
        public int? VTS_S1_RE { get; set; }
