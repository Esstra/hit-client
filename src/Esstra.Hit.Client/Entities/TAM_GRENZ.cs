...
namespace Esstra.Hit.Client.Entities
{
    ...
    /// <summary>
    /// Veröffentlichung der Grenzwerte TAM (nach § 58c AMG)
    /// </summary>
    [Entity("TAM_GRENZ")]
    public class TAM_GRENZ
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the value of "Antibiotika Therapiehäufigkeit 3.Quartil".
        /// </summary>
        [Column("TAM_3QUART")]
        [Required]
        public decimal? TAM_3QUART { get; set; }

        /// <summary>
        /// Gets or sets the value of "Antibiotika Therapiehäufigkeit Median".
        /// </summary>
        [Column("TAM_MEDIAN")]
        [Required]
        public decimal? TAM_MEDIAN { get; set; }
