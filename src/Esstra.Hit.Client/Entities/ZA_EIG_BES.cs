...
namespace Esstra.Hit.Client.Entities
{
    ...
    /// <summary>
    /// Zahlungsansprüche, Eigentum oder Besitz (Sicht für Register)
    /// </summary>
    [Entity("ZA_EIG_BES")]
    public class ZA_EIG_BES
    {
        /// <summary>
        ...
        [Column("ZA_EB_BIS")]
        [Required]
        public DateTime? ZA_EB_BIS { get; set; }
        ...
        [Column("ZA_EB_VON")]
        [Required]
        public DateTime? ZA_EB_VON { get; set; }
        ...
        [Column("ZA_EIG_BES")]
        [Required]
        [JsonPropertyName("ZA_EIG_BES")]
        public bool? _ZA_EIG_BES { get; set; }
